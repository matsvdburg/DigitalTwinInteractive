...
var info = L.control.sideBySide(econLayer1, econLayer2).addTo(map)
...
map.on('draw:created', function (e) {
    ...
    document.getElementById("algemeen2").innerHTML = 
    drawnItems.getLayers().length; + "<br />";
    ...
    +
        ...
        +
        '<input type="text" placeholder="bv: 2.2 meter" id="kroon_hoogte" name="kroon_hoogte" class="form-control"/>'
        + 
    '</div>'
    +
    '<div class="form-group">'
    ...
    +
        ...
        +
        '<input type="text" placeholder="bv: 4.5 meter " id="stam_hoogte" name="stam_hoogte" class="form-control"/>'
        + 
    '</div>'
    +
    '<div class="form-group">'
